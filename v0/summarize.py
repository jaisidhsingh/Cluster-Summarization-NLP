...
def get_summary(articles, threshold):
	"""
	articles: (list) a list of strings which are the articles to summarize
	threshold: (float) the distance threshold for the Agglomerative Clustering of sentences
	"""
